      ...
      <div className="card lg:card-side bg-base-100 shadow-md my-4 mb-15">
        ...
        <div className="card-body">
          ...
          <div className="flex items-center gap-4 mb-2">
            <span className="bg-sky-700 text-white py-3 px-5 rounded-xl">
              {details.rating.score} <i className="fa-solid fa-star"></i>
            </span>

            <div className="flex flex-col items-center">
              <span>{details.rating.status}</span>
              <span className="text-gray-300">
                {details.rating.reviewCount} Review
              </span>
            </div>
          ...
          <div className="border rounded-2xl shadow-md p-4 w-64 bg-white text-gray-800 mb-3">
            ...
            <div className="mt-2">
              ...
              <span className="text-xl font-bold text-green-600">
                {details.pricing[0].discountedPrice}{" "}
          ...
          <div className="mb-3">
            <span>
              ...
              {details.address.country}, {details.address.countryIsoCode}
            </span>
          </div>

          <div>
            <i className="fa-solid fa-hotel mr-2"></i>
            <span>{details.amenities[0]}, </span>
            <span>{details.amenities[1]}, </span>
            <span>{details.amenities[2]}, </span>
            <span>{details.amenities[3]} </span>
          </div>
